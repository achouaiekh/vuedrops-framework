...
var _class = function () {
    ...
    _createClass(_class, [{
        ...
        key: 'setupCurrentSlide',
        value: function setupCurrentSlide() {
            //setup the initial current slide to meet the current page
            this.currentSlide = this.previousSlide = Math.floor(this.currentSlide / this.slideToScrollCount) * this.slideToScrollCount;
        }
    }, {
        key: 'initProps',
        ...
        value: function setupSlideToShowAndToScroll() {
            var _this2 = this;

            if (this.fade) return this.slideToScrollCount = this.slideToShowCount = 1;
            ...
            if (this.slideCount <= this.slideToShowCount) this.slideToShowCount = this.slideCount;
        ...
        key: 'getPaginationComponent',
        value: function getPaginationComponent() {
            if (this.vm.$refs.hasOwnProperty('pagination')) return this.vm.$refs.pagination;
            if (this.vm.$slots.hasOwnProperty('pagination')) return this.vm.$slots.pagination.pop().componentInstance;
        }
    }, {
        key: 'totalPages',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_pagination_pagination_vue__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_icon_icon_vue__ = __webpack_require__(6);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition-group', {
    ...
    staticClass: "pagination__item",
    class: {
      'pagination__item--disabled': _vm.value === _vm.totalPages && !_vm.cycle
    },
    on: {
      "click": function($event) {
        _vm.next($event)
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "pagination",
    staticClass: "pagination__dot pagination__dot--hop white--text",
    class: _vm.paginationClass,
    attrs: {
      "shown-pages": _vm.paginationShownPage,
      "cycle": "",
      "chevron": ""
    }
  })]), _vm._v(" "), _c('a', {
